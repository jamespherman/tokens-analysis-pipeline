...
conditions.is_norm_rare_low = conditions.is_normal_dist & (trialInfo.rewardAmt <= 2);
conditions.is_norm_common = conditions.is_normal_dist & (trialInfo.rewardAmt >= 4 & trialInfo.rewardAmt <= 6);
conditions.is_norm_rare_high = conditions.is_normal_dist & (trialInfo.rewardAmt >= 8);
conditions.is_unif_low = conditions.is_uniform_dist & (trialInfo.rewardAmt <= 3);
conditions.is_unif_mid = conditions.is_uniform_dist & (trialInfo.rewardAmt >= 4 & trialInfo.rewardAmt <= 6);
conditions.is_unif_high = conditions.is_uniform_dist & (trialInfo.rewardAmt >= 7);

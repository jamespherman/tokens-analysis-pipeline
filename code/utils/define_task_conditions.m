...
%
% OUTPUTS:
%   conditions:     struct of logical masks for trial conditions, specific to a single session's data.
%   is_av_session:  Boolean, true if the session contains AV trials.
%   condition_defs: struct containing the full, session-agnostic analysis_plan.
...
roc_plan_def = { ...
    % Comparison Type: Dist
    'Dist_at_Cue',     'CUE_ON',    condition_defs.condition_masks.distribution{1},      condition_defs.condition_masks.distribution{2},      false; ...
    'Dist_at_Outcome', 'outcomeOn', condition_defs.condition_masks.distribution{1},      condition_defs.condition_masks.distribution{2},      false; ...
    'Dist_at_Reward',  'reward',    condition_defs.condition_masks.distribution{1},      condition_defs.condition_masks.distribution{2},      false; ...
    ...
    % Comparison Type: RPE
    'RPE_at_Cue',      'CUE_ON',    condition_defs.condition_masks.RPE_comparison_pair{1}, condition_defs.condition_masks.RPE_comparison_pair{2}, false; ...
    ...
    ...
    % Comparison Type: SPE
    'SPE_at_Cue',      'CUE_ON',    condition_defs.condition_masks.SPE_comparison_pair{1}, condition_defs.condition_masks.SPE_comparison_pair{2}, true;  ...
    ...
    'SPE_at_Reward',   'reward',    condition_defs.condition_masks.SPE_comparison_pair{1}, condition_defs.condition_masks.SPE_comparison_pair{2}, true   ...
};
